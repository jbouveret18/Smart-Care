...
<body>
    ...
    <div class="montre" id="discover">
        ...
        <div class="three">
            ...
            Calcule la fréquence cardiaque et élabore votre condition physique en fonction des activités que vous réalisé
        </div>
        <div class="four">
            <img src="../img/speaker.svg" >
            <h3>Capteur Sonore</h3>
            Mesure la puissance sonore de votre environnement et détecte les potentiels risques de dommage pour votre oreille
        </div>
        <div class="five">
